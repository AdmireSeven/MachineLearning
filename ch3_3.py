...
def getinfo():
    ...
    global total_photo
    file = os.listdir('D:\\01 A  Dream\\09 机器学习\\ch3\\face_images\\')
    i = 0
    for subfile in file:
        photo = os.listdir('D:\\01 A  Dream\\09 机器学习\\ch3\\face_images\\' + subfile)
        for name in photo:
            photo_name.append(r'D:\\01 A  Dream\\09 机器学习\\ch3\\face_images\\' + subfile + '\\'+name)
            target.append(i)
        i += 1
